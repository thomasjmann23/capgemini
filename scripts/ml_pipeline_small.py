...
def train_models(X_train, X_test, y_train, y_test, X_train_scaled, X_test_scaled, features):
    """
    Step 4: Model Training and Evaluation - OPTIMIZED FOR SPEED
    ...
    """
    print("\n" + "="*50)
    print("STEP 4: Model Training and Evaluation (Speed Optimized)")
    print("="*50)
    ...
    # 2. Random Forest (SIMPLIFIED - use good default params to save time)
    print("--- Training Random Forest (using optimized defaults) ---")
    # Use the best params from your previous run to save time
    ...
    print("✓ RF trained with optimized parameters")
    
    # 3. XGBoost (SIMPLIFIED - use good default params to save time)
    print("--- Training XGBoost (using optimized defaults) ---")
    # Use the best params from your previous run to save time
    ...
    print("✓ XGBoost trained with optimized parameters")
